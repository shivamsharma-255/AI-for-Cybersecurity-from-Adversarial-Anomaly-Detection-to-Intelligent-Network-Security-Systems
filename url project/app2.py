...
def process():
	...
	model = joblib.load(r'C:\Users\shiva\Desktop\AI for Cybersecurity from Adversarial Anomaly Detection to Intelligent Network Security Systems\url project\trained__model.pkl')
	# In[51]:
